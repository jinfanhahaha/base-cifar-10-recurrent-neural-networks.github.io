            ...
            conv2_x ~ conv5_x:
                every conv:
                    conv -> global pooling 1x1xC
                         ...
                         -> scale
                    conv = conv x scale
            conv2_x: |1x1 32|   relu=None
                     |3x3 32|
                     |1x1 128|  x3
            conv3_x: |1x1 64|   relu=None
                     |3x3 64|
                     |1x1 256|  x4
            conv4_x: |1x1 128|  relu=None
                     |3x3 128|
                     |1x1 512|  x6
            conv5_x: |1x1 256|  relu=None
                     |3x3 256|
                     |1x1 1024| x3
            fc49: -> 100
            fc50: -> 10  + softmax
...
def residual_block1(x):
    ...
    strides = (1, 1)
    conv1 = SE_conv(x, 32, strides, (3, 3), "conv1", 16, None)
    print(conv1)
...
def residual_block2(x):
    """residual connection implementation"""
    strides = (1, 1)
    conv1 = SE_conv(x, 64, strides, (3, 3), "conv1", 16, None)
    print(conv1)
...
def residual_block3(x):
    """residual connection implementation"""
    strides = (1, 1)
    conv1 = SE_conv(x, 128, strides, (3, 3), "conv1", 16, None)
    print(conv1)
...
def residual_block4(x):
    """residual connection implementation"""
    strides = (1, 1)
    conv1 = SE_conv(x, 256, strides, (3, 3), "conv1", 16, None)
    print(conv1)
