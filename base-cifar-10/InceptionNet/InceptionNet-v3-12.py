...
def inception_block(x,
    ...
    with tf.variable_scope(name):
        ...
        conv3_2_1_3 = tf.layers.conv2d(conv3_2_3_1,
                                       ...
                                       activation=tf.nn.relu,
                                       name='conv3_2_1_3')
        max_pooling_1 = tf.layers.max_pooling2d(x,
                                              (2, 2),
                                              (2, 2),
                                              name='max_pooling_1')
        max_pooling_2 = tf.layers.conv2d(max_pooling_1,
    ...
    max_pooling_shape = max_pooling_2.get_shape().as_list()[1:]
    input_shape = x.get_shape().as_list()[1:]
    width_padding = (input_shape[0] - max_pooling_shape[0]) // 2
    height_padding = (input_shape[1] - max_pooling_shape[1]) // 2
    padded_pooling = tf.pad(max_pooling_2,
                            [[0, 0],
