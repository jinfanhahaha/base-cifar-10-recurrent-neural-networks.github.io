...
'''
            ...
            conv2 ~ conv11:
                every conv:
                    ...
                    conv = conv x scale
            conv2:   3x3 32 1
            conv3:   inception_2a[16, 32, 8, 8]
            conv4:   inception_2b[32, 48, 24, 16]
            conv5:   inception_3a[48, 52, 12, 16]
            conv6:   inception_3b[40, 56, 16, 16]
            conv7:   inception_3c[28, 64, 16, 16]
            conv8:   inception_3d[28, 72, 16, 16]
            conv9:   inception_3e[64, 80, 32, 32]
            conv10:   inception_4a[64, 80, 32, 32]
            conv11:   inception_4b[96, 96, 32, 32]
            dropout(40%)
            fc12: -> 10  + softmax
...
def inception_block(x,
    ...
    with tf.variable_scope(name):
        conv1_1 = SE_conv(x, output_channel_for_each_path[0], (1, 1), (1, 1), name="conv1_1", R=16)

        conv2_3_1 = SE_conv(x, output_channel_for_each_path[1], (1, 1), (3, 1), name="conv2_3_1", R=16)
        conv2_1_3 = SE_conv(conv2_3_1, output_channel_for_each_path[1], (1, 1), (1, 3), name="conv2_1_3", R=16)

        conv3_1_3_1 = SE_conv(x, output_channel_for_each_path[2], (1, 1), (3, 1), name="conv3_1_3_1", R=16)
        conv3_1_1_3 = SE_conv(conv3_1_3_1, output_channel_for_each_path[2], (1, 1), (1, 3), name="conv3_1_1_3", R=16)
        conv3_2_3_1 = SE_conv(conv3_1_1_3, output_channel_for_each_path[2], (1, 1), (3, 1), name="conv3_2_3_1", R=16)
        conv3_2_1_3 = SE_conv(conv3_2_3_1, output_channel_for_each_path[2], (1, 1), (1, 3), name="conv3_2_1_3", R=16)
    ...
    concat_layer = tf.concat(
        [conv1_1, conv2_1_3, conv3_2_1_3, padded_pooling],
        axis=3)
    return concat_layer
...
with tf.name_scope("build_network"):
    ...
    inception_2a = inception_block(conv2,
                                   [16, 32, 8, 8],
                                   name='inception_2a')
    ...
    inception_3b = inception_block(inception_3a,
                                   [40, 56, 16, 16],
                                   name='inception_3b')
    inception_3c = inception_block(inception_3b,
                                   [28, 64, 16, 16],
                                   name='inception_3c')
    inception_3d = inception_block(inception_3c,
                                   [28, 72, 16, 16],
                                   name='inception_3d')
    inception_3e = inception_block(inception_3d,
                                   [64, 80, 32, 32],
                                   name='inception_3e')

    pooling3 = tf.layers.max_pooling2d(inception_3e,
                                       (2, 2),  # kernel size
                                       (2, 2),  # stride
                                       name='pool3')
    inception_4a = inception_block(pooling3,
                                   [64, 80, 32, 32],
                                   name='inception_4a')
    ...
    flatten = tf.layers.flatten(inception_4b)
    L1_drop = tf.nn.dropout(flatten, keep_prob)
    y_ = tf.layers.dense(L1_drop, 10)
