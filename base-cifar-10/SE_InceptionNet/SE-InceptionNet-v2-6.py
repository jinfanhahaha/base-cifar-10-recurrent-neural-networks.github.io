...
def inception_block(x,
    ...
    with tf.variable_scope(name):
        ...
        conv3_3 = SE_conv(x, output_channel_for_each_path[1], (1, 1), (3, 3), name="conv3_3", R=16)

        conv5_5_1 = SE_conv(x, output_channel_for_each_path[2], (1, 1), (3, 3), name="conv5_5_1", R=16)
        conv_5_5_2 = SE_conv(conv5_5_1, output_channel_for_each_path[2], (1, 1), (3, 3), name="conv5_5_2", R=16)
    ...
    concat_layer = tf.concat(
        [conv1_1, conv3_3, conv_5_5_2, padded_pooling],
        axis=3)
    return concat_layer
