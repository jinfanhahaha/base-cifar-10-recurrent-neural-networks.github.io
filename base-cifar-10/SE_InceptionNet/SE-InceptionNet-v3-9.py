            ...
            conv2 ~ conv8:
                every conv:
                    conv -> global pooling 1x1xC
                         ...
                         -> scale
                    conv = conv x scale
            conv2:   inception_2a[16, 32, 8, 8]
            conv3:   inception_2b[32, 48, 24, 16]
            conv4:   inception_3a[48, 52, 12, 16]
            conv5:   inception_3b[40, 56, 16, 16]
            conv6:   inception_3c[28, 64, 16, 16]
            conv7:   inception_3d[28, 72, 16, 16]
            conv8:   inception_3e[64, 80, 32, 32]
            fc9: -> 10  + softmax
